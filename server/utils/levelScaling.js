// レベル差によるダメージ補正（クライアント側 client/utils/levelScaling.js と同じロジック）
...
function getLevelDiffMultiplier(attackerLevel = 1, defenderLevel = 1) {
...
module.exports = { getLevelDiffMultiplier };
